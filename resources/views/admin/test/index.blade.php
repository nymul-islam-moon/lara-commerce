...
<!-- Mirrored from themesbrand.com/velzon/html/default/widgets.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 22 Mar 2023 05:43:29 GMT -->
<head>
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">$<span class="counter-value" data-target="100">0</span>k</h4>
    ...
    {{-- <script src="{{ asset('dashboard/assets/libs/card/card.js') }}"></script> --}}

    <!-- Widget init -->
    {{-- <script src="{{ asset('dashboard/assets/js/pages/widgets.init.js') }}"></script> --}}
...
<!-- Mirrored from themesbrand.com/velzon/html/default/widgets.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 22 Mar 2023 05:43:30 GMT -->
</html>
